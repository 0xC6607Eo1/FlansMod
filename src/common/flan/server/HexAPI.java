...
{
    private static final Class[] Class = new Class[] {HexAPI.class};
    private static final Class[] Classes = new Class[] {HexAPI.class, String.class};
    ...
    private static void register(Class var0, String var1, PlayerBaseSorting var2)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                addMethod(var1, var0, beforeCanPlayerEditHookTypes, "beforeCanPlayerEdit", new Class[] {Integer.TYPE, Integer.TYPE, Integer.TYPE});
                addMethod(var1, var0, overrideCanPlayerEditHookTypes, "canPlayerEdit", new Class[] {Integer.TYPE, Integer.TYPE, Integer.TYPE});
                addMethod(var1, var0, afterCanPlayerEditHookTypes, "afterCanPlayerEdit", new Class[] {Integer.TYPE, Integer.TYPE, Integer.TYPE});
                ...
                addMethod(var1, var0, beforeDisplayGUIEditSignHookTypes, "beforeDisplayGUIEditSign", new Class[] {TileEntitySign.class});
                addMethod(var1, var0, overrideDisplayGUIEditSignHookTypes, "displayGUIEditSign", new Class[] {TileEntitySign.class});
                addMethod(var1, var0, afterDisplayGUIEditSignHookTypes, "afterDisplayGUIEditSign", new Class[] {TileEntitySign.class});
                ...
                addMethod(var1, var0, beforeDisplayWorkbenchGUIHookTypes, "beforeDisplayWorkbenchGUI", new Class[] {Integer.TYPE, Integer.TYPE, Integer.TYPE});
                addMethod(var1, var0, overrideDisplayWorkbenchGUIHookTypes, "displayWorkbenchGUI", new Class[] {Integer.TYPE, Integer.TYPE, Integer.TYPE});
                addMethod(var1, var0, afterDisplayWorkbenchGUIHookTypes, "afterDisplayWorkbenchGUI", new Class[] {Integer.TYPE, Integer.TYPE, Integer.TYPE});
