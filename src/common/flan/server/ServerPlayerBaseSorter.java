...
public final class ServerPlayerBaseSorter implements Comparator
{
	...
	public ServerPlayerBaseSorter(List var1, Map var2, Map var3, String var4)
	{
		this.list = var1;
			...
			if (this.directInferiorsMap != null)
			{
				for (var1 = 0; var1 < this.list.size() - 1; ++var1)
				{
					for (int var13 = var1 + 1; var13 < this.list.size(); ++var13)
					{
						...
						if (var9 && var11)
						{
							throw new UnsupportedOperationException("Can not sort ServerPlayerBase classes for method \'" + this.methodName + "\'. \'" + var14 + "\' wants to be inferior to \'" + var15 + "\' and \'" + var15 + "\' wants to be inferior to \'" + var14 + "\'");
						}

						if (var10 && var12)
						{
							throw new UnsupportedOperationException("Can not sort ServerPlayerBase classes for method \'" + this.methodName + "\'. \'" + var14 + "\' wants to be superior to \'" + var15 + "\' and \'" + var15 + "\' wants to be superior to \'" + var14 + "\'");
						}

						if (var9 && var10)
						{
							throw new UnsupportedOperationException("Can not sort ServerPlayerBase classes for method \'" + this.methodName + "\'. \'" + var14 + "\' wants to be superior and inferior to \'" + var15 + "\'");
						}

						if (var11 && var12)
						{
							throw new UnsupportedOperationException("Can not sort ServerPlayerBase classes for method \'" + this.methodName + "\'. \'" + var15 + "\' wants to be superior and inferior to \'" + var14 + "\'");
						}
					}
				}
	...
	private Set build(String var1, Set var2, String var3)
	{
		...
		} else
		{
			...
			while (var5.hasNext())
			{
				...
				if (var6 == var3)
				{
					throw new UnsupportedOperationException("Can not sort ServerPlayerBase classes for method \'" + this.methodName + "\'. Circular superiosity found including \'" + var3 + "\'");
				}
				...
				{
					throw new UnsupportedOperationException("Can not sort ServerPlayerBase classes for method \'" + this.methodName + "\'. Circular superiosity found including \'" + var6 + "\'", var9);
				}
