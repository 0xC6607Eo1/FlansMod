...
public class ModelAAGun extends ModelBase
{
	...
	public NMTModelRenderer seatModel[];		//The bit which swivels around the yaw axis, but which does not pitch
	public NMTModelRenderer gunModel[];		//The bit of the gun that points where you look, but doesn't move
	public NMTModelRenderer barrelModel[][];	//The end of the barrel that recoils
