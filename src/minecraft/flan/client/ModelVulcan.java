...
public class ModelVulcan extends ModelMG
{
    public ModelVulcan()
    {
		bipodModel = new ModelRenderer[3];
		bipodModel[0] = new ModelRenderer(this, 0, 0);
		...
		bipodModel[1] = new ModelRenderer(this, 0, 0);
