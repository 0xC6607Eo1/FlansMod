...
/**
 * <p>All models that can be created with Nitro Model Thingy find
 * their basis at this class.</p>
 * 
 * <p>In order to dynamically load models properly, the creation of the
 * model itself has been separated from the constructor. This means that
 * the variables that get set in the parameters of the constructor have
 * to be stored in the class itself for later use. You can look at the
 * subclasses for more information on this.</p>
 * 
...
public abstract class NMTModelBase
{
	...
	/**
	 * <p>Sets all polygons to invert the normals.</p>
	 */
